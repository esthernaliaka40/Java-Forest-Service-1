...
public class App {
    ...
    public static void main(String[] args) {
        ...
        get("/wildlifeRanger", (request, response) -> {
            Map<String, Object> model = new HashMap<String, Object>();
            ArrayList<RangerAnimal> testRanger = RangerAnimal.getAllInstances();
        ...
        post("/animalSighting", (request, response) -> {
            ...
            AnimalSighting testSighting = new AnimalSighting(name, location, health, age, species, animalRangerName );
        ...
        get("/animalSighting", (request, response) -> {
            Map<String, Object> model = new HashMap<String, Object>();
            ArrayList<AnimalSighting> testSighting = AnimalSighting.getAllInstances();
            model.put("sighting", testSighting);
        ...
        post("/animalLocation", (request, response) -> {
            ...
            AnimalLocation testLocation = new AnimalLocation(name, id);
        ...
        get("/animalLocation", (request, response) -> {
            Map<String, Object> model = new HashMap<String, Object>();
            ArrayList<AnimalLocation> testLocation = AnimalLocation.getAllInstances();
            model.put("location", testLocation);
